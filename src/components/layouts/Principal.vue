      ...
      <v-list dense nav>
        <v-list-item-group color="teal">
          ...
          <v-list-item link to="/colaborador" class="mt-2">
            ...
            <v-list-item-content>
              <v-list-item-title
                @click.prevent="$router.replace('/colaborador')"
                >Consulta colaborador 2.0</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
          ...
          <v-list-item link to="/postulantes">
            ...
            <v-list-item-content>
              <v-list-item-title
                @click.prevent="$router.replace('/postulantes')"
                >Consulta de postulantes</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
          ...
          <v-list-item v-if="showPerfiles()" link to="/registro">
            ...
            <v-list-item-content>
              <v-list-item-title @click.prevent="$router.replace('/registro')"
                >Registro de invitados</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
          ...
          <v-list-item link to="/listaInvitados" class="mt-2">
            ...
            <v-list-item-content>
              <v-list-item-title @click="$router.replace('/listaInvitados')"
                >Lista de invitados</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
        </v-list-item-group>
